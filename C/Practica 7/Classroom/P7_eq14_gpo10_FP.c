/*
Se pide al usuario un numero entero entre 1 y 4 para 
acceder a alguna opcion y ejecutar el programa del 
ejercicio. Si el número que introduce el usuario no 
esta en el rango aceptado imprime el mensaje "Datos
no validos". Luego hace la pregunta de si quiere 
repetir la ejecución del ejercicio o volver al menu.
*/
#include <stdio.h>
#include <math.h>
...
rejercicio5:
  ...
  printf("Menu\n");
  printf("\n");
  printf("Eliga el ejercicio para acceder:");
